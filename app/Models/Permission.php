...
class Permission extends \Spatie\Permission\Models\Permission
{
    ...
    public static function defaultPermissions()
    {
        $array = [
            ...
            ['module'=>'Post','name'=>'view_post','display'=>'View Posts'],
            ['module'=>'Post','name'=>'add_post','display'=>'Add Posts'],
            ['module'=>'Post','name'=>'edit_post','display'=>'Edit Posts'],
            ['module'=>'Post','name'=>'delete_post','display'=>'Delete Posts']
        ];
